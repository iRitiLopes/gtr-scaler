...
def test_render_basic():
    ...
    result = renderer.render(cells, fret_start=0, fret_end=12)
...
def test_render_grid_structure():
    ...
    scale = catalog.get("pentatonic_minor")
    cells = projector.project("A", scale, 0, 5)
    result = renderer.render(cells, fret_start=0, fret_end=5)
    # frets 0-5 = 6 frets
...
def test_render_notes_per_string():
    ...
    scale = catalog.get("pentatonic_minor")
    cells, _ = projector.project_n_notes("A", scale, 3, 0)
    result = renderer.render(cells, fret_start=0, fret_end=22)
...
def test_render_xss_title():
    ...
    scale = catalog.get("pentatonic_minor")
    cells = projector.project("A", scale, 0, 12)
    result = renderer.render(cells, fret_start=0, fret_end=12, title='<script>alert("xss")</script>')
...
def test_render_fret_range():
    ...
    scale = catalog.get("pentatonic_minor")
    cells = projector.project("A", scale, 5, 9)
    result = renderer.render(cells, fret_start=5, fret_end=9)
